...
define("common/wx/Tips.js", [], function(e, s) {
	"use strict";
...
define("common/wx/popup.js", ["common/wx/widgetBridge.js", "tpl/popup.html.js"], function(t) {
	...
	$.widgetBridge("popup", {
		...
		_create: function() {
			...
			var s;
			if (this.element.is("script[type=text/html]")) s = this.element.html(), this.options.data && this.options.template && (s = this.options.template(s)(this.options.data));
			else {
				var l = $("<div></div>").append(this.element.clone()),
					s = l.html();
